# Oque é Security Operations Center (SOC)
O centro de Operações de Segurança (SOC), é aonde várias equipes especializadas monitoram, 
detectam e respondem a ameaças cibernéticas em tempo real.

O SOC tem o papel fundamental de coleta, analise e resposta a eventos de segurança em tempo real. 
É se utilizado de ferramentas como SIEM e outras para correlacionar eventos e identificar possíveis
ataques.

O SOC possui como seus principais componentes:
...
# Diferença entre SOC N1, N2 e N3
## SOC N1
É o "primeiro nível" de suporte em um Security Operations Center (SOC). Eles monitoram alertas 
...
## SOC N3
É o "terceiro nível", o mais avançado. São os especialistas que entram em ação para os casos mais
